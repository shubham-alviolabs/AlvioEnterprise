      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <FadeIn>
            <div className="text-center mb-16">
                ...
                <h2 className="text-4xl md:text-7xl font-medium text-gray-900 dark:text-white mb-6 tracking-tight">
        ...
        <div className="flex justify-center mb-24">
            <div className="flex flex-wrap justify-center gap-2 p-1.5 rounded-full border border-black/5 dark:border-white/10 bg-white dark:bg-white/[0.02] backdrop-blur-xl shadow-sm dark:shadow-none">
                {tabs.map((tab) => (
                    <button 
                        key={tab.id}
                        onClick={() => setActiveTab(tab.id as any)}
                        className={`group relative px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-500 overflow-hidden flex items-center gap-2 ${
                            activeTab === tab.id 
            ...
            {activeTab === 'search' && (
                <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 grid lg:grid-cols-2 gap-20 items-center">
                    <div className="order-2 lg:order-1">
                        <h3 className="text-4xl md:text-5xl font-medium text-gray-900 dark:text-white mb-6 leading-tight">
                            The Neural Index. <br/>
                    ...
                    <div className="order-1 lg:order-2 relative h-[500px] w-full perspective-1000 group">
