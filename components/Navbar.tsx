...
export const Navbar: React.FC = () => {
  ...
  const platformSubItems = [
    ...
    { href: '/workflows', id: 'workflows', label: 'Agents', color: 'from-accent-purple to-purple-600', isRoute: true },
  ];
  ...
  ) || ['/enterprise-search', '/apps', '/workflows'].includes(location.pathname);
