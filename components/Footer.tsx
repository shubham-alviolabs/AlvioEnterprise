...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-white dark:bg-black py-32 px-6 border-t border-black/5 dark:border-white/10 transition-colors duration-500">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-5xl md:text-7xl font-medium text-gray-900 dark:text-white mb-8 tracking-tight">
        ...
        <div className="grid md:grid-cols-4 gap-8 text-left border-t border-black/5 dark:border-white/10 pt-16">
          <div>
