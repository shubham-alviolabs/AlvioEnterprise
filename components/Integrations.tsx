...
const icons = {
  ...
  // Finance
  xero: <path d="M13.17 8.47c1.15-1.18 1.83-2.8 1.83-4.58C15 1.74 13.26 0 11.11 0H0v2.78h11.11c.64 0 1.16.52 1.16 1.16 0 .64-.52 1.16-1.16 1.16H7.89L0 13.53V24h11.11c2.15 0 3.89-1.74 3.89-3.89 0-1.78-.68-3.4-1.83-4.58.39-.13.75-.32 1.08-.56.33.24.69.43 1.08.56-1.15 1.18-1.83 2.8-1.83 4.58 0 2.15 1.74 3.89 3.89 3.89H24v-2.78h-6.61c-.64 0-1.16-.52-1.16-1.16 0-.64.52-1.16 1.16-1.16h3.22L24 10.47V0H12.89c-2.15 0-3.89 1.74-3.89 3.89 0 1.78.68 3.4 1.83 4.58-.39.13-.75.32-1.08.56-.33-.24-.69-.43-1.08-.56z"/>,
  quickbooks: <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm3.5 17c-.3.2-.7.3-1.1.3-1.9 0-3.4-1.5-3.4-3.4V9.1c0-.3-.2-.6-.6-.6-.3 0-.6.2-.6.6v4.8c0 2.5 2 4.5 4.5 4.5.6 0 1.2-.1 1.7-.3l-.5-1zm-7-1.1c.3-.2.7-.3 1.1-.3 1.9 0 3.4 1.5 3.4 3.4v4.8c0 .3.2.6.6.6.3 0 .6-.2.6-.6v-4.8c0-2.5-2-4.5-4.5-4.5-.6 0-1.2.1-1.7.3l.5 1z"/>,
  sage: <path d="M3.43 7.09C4.95 5.57 7.03 4.8 9.6 4.8c2.06 0 3.94.55 5.14 1.49v4.63h-4.46v-2.4c-.34-.09-.91-.17-1.49-.17-1.54 0-2.57.51-2.57 1.54 0 3.09 9.26 1.89 9.26 7.37 0 3-2.4 4.97-6.69 4.97-2.74 0-5.14-.86-6.52-2.23v-4.8h4.46v2.63c.51.17 1.2.26 1.89.26 1.63 0 2.74-.6 2.74-1.71 0-3.26-9.26-2.06-9.26-7.54 0-2.4 1.63-4.37 4.8-4.97V0h2.74v3.86c1.03.17 1.97.51 2.74.94v3.94h-4.46v-1.8c-.34-.09-.77-.17-1.2-.17-1.46 0-2.4.51-2.4 1.54 0 3.09 9.26 1.89 9.26 7.37 0 3-2.4 4.97-6.69 4.97-2.74 0-5.14-.86-6.52-2.23v-4.8h4.46v2.63c.51.17 1.2.26 1.89.26 1.63 0 2.74-.6 2.74-1.71 0-3.26-9.26-2.06-9.26-7.54 0-2.83 1.97-4.8 5.83-5.14z"/>,
  netsuite: <path d="M13.7 3.9L24 0v24L13.7 20.1V3.9zM0 7.3l10.3 3.9v9.5L0 16.8V7.3zm10.3-3.4v3.8L0 3.9 10.3 0v3.9z"/>,
  zoho: <path d="M4.8 0C2.1 0 0 2.1 0 4.8v14.4C0 21.9 2.1 24 4.8 24h14.4c2.7 0 4.8-2.1 4.8-4.8V4.8C24 2.1 21.9 0 19.2 0H4.8zm7.68 6.24c2.112 0 3.84 1.728 3.84 3.84 0 2.112-1.728 3.84-3.84 3.84-2.112 0-3.84-1.728-3.84-3.84 0-2.112 1.728-3.84 3.84-3.84zm-4.8 7.68h9.6v1.44c0 1.584-1.296 2.88-2.88 2.88h-3.84c-1.584 0-2.88-1.296-2.88-2.88v-1.44z"/>, 
